    ...
    {           $send_email= $this->spUtility->getStoreConfig(SPConstants::SEND_EMAIL);
        ...
        if($send_email==NULL)
         {  $currentAdminUser =  $this->spUtility->getCurrentAdminUser()->getData(); 
            ...
            Curl::submit_to_magento_team($userEmail, 'Installed Successfully-Attribute Setting Tab', $values, $magentoVersion);
...
/**
    ...
    private function processValuesAndSaveData($params)
    {
        ...
        $this->spUtility->setStoreConfig(SPConstants::GROUPS_MAPPED, 'General');
